module EtudeForOps
  class CodeDeploy < Platform
    ...
    def src_ship_dir
      "#{@platform.src_ship_dir}/aws/code_deploy"
    end

    def erb_file(file)
      "#{@platform.tmp_file_dir}/platform/aws/code_deply/#{file}.erb"
    end

    def erb_share_file(file)
      "#{@platform.tmp_share_file_dir}/99_share/platform/aws/code_deploy/#{file}.erb"
    end
